...
class InterpretationService(AbstractLLMInterpreter):
    """
    ...
    async def interpret(self, context: str, ml_score: float) -> Dict[str, Any]:
        ...
        - plan: detailed clinical action plan (as a dictionary with keys: immediateActions, medicationManagement, lifestyleInterventions, followUp). Each key MUST be a list of strings (e.g., ["Action 1", "Action 2"]).
        """
