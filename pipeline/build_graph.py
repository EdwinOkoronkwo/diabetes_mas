...
def build_pipeline_graph():
    ...
    # Set Entry Point
    graph_builder.set_entry_point(io_node_name)

    # Add Edges (Linear Flow)
    graph_builder.add_edge(io_node_name, retrieval_node_name)
